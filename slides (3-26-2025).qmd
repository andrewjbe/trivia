...
```{r}
song_params <- "?autoplay=1&controls=0&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3"

music_break1 <- "https://www.youtube.com/embed/wqVsfGQ_1SU" 
my_songs1 <- "https://www.youtube.com/embed/BK30r_SIZ-g" 
my_songs2 <- "https://www.youtube.com/embed/gGdGFtwCNBE"
my_songs3 <- "https://www.youtube.com/embed/HQmmM_qwG4k"
my_songs4 <- "https://www.youtube.com/embed/wp43OdtAAkM"
music_break2 <- "https://www.youtube.com/embed/_qzacv8dtb4"
...
> 10 *kilometers* is equal to how many *decameters*?
...
::: incremental
-   **Answer:** [**1,000 (100 per kilometer)**]{.underline}
:::
...
<!-- ## {background-iframe=`r paste0(music_break1, song_params)` referrerpolicy="unsafe-url" allow="autoplay"} -->
...
<!-- ## {background-iframe=`r paste0(my_songs1, song_params)` allow="autoplay"} -->
...
<!-- ## {background-iframe=`r paste0(my_songs2, song_params)` allow="autoplay"} -->
...
<!-- ## {background-iframe=`r paste0(my_songs3, song_params)` allow="autoplay"} -->
...
<!-- ## {background-iframe=`r paste0(my_songs4, song_params)` allow="autoplay"} -->
...
<!-- ## {background-iframe=`r paste0(music_break2, song_params)` allow="autoplay"} -->
