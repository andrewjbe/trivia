...
# Round 5: *The Ides of March Madness*
...
> Hell is empty, and all the Blue Devils are at what #1 seed from the ACC?
...
> What Shakespeare play opens with the famous line "If music be the food of love, play on!" and shares its initials with the postal code of the home state of the "Volunteers"?
...
::: incremental
-   **Answer:** [**The Ohio State Buckeyes (OSU)**]{.underline}
:::
...
::: incremental
-   **Answer:** [**Twelfth Night**]{.underline}
    - The University of *Tennessee's* (TN) sports teams are known as the Volunteers, or "Vols" for short.
:::
